...
echo "        <input type='Text' id='NumDoc' name='NumDoc' maxlength='20' Value='' required = 'required'/>";
echo "    </div><br>";
echo "    <div id='DivDatosBusq'>";
echo "        <label for='Apellido1'>Primer Apellido</label>";
echo "        <input type='Text' id='Apellido1' name='Apellido1' Value='' />";
echo "        <label for='Apellido2'>Segundo Apellido</label>";
echo "        <input type='Text' id='Apellido2' name='Apellido2' Value='' />";
echo "    </div><br>";
echo "    <div id='DivDatosBusq'>";
echo "        <label for='Nombre1'>Primer Nombre:</label>";
echo "        <input type='Text' id='Nombres1' name='Nombres1' Value='' />";
echo "        <label for='Nombre2'>Segundo Nombre:</label>";
echo "        <input type='Text' id='Nombres2' name='Nombres2' Value=''/>";
echo "    </div><br>";
echo "    <div id='DivDatosBusq'>";
...
echo "        <input type='Text' id='fnacimiento' name='fnacimiento' Value=''/>";
echo "    </div><br>";
echo "    <div id='DivDatosBusq'>";
...
echo "        <input type='Text' id='Tel' name='Tel' Value=''/>";
echo "    </div><br>";
echo "    <div id='DivDatosBusq'>";
echo "        <label for='Dir'>Direccion:</label>";
echo "        <input type='Text' id='Dir' name='Dir' Value=''/>";
echo "    </div><br>";
// echo "";
echo "    <div id='BtnFrm1Ppl'>";
echo "        <input Id='btnN' name='btnN' type='submit' Value= 'Nuevo'>";
echo "		    <input Id='btnM' name='btnM' type='submit' Value= 'Modifica'>";
